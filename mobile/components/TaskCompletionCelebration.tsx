...
function createCelebrationStyles(W: WellnessPalette) {
  return StyleSheet.create({
    ...
    backBtn: { alignSelf: "flex-start", marginBottom: gapSection },
    ...
    previewRow: { flexDirection: "row", gap: gapSection, alignItems: "flex-start" },
    previewTitle: {
      fontSize: 16,
      fontWeight: "700",
      color: W.text,
    ...
    previewMeta: { fontSize: 12, color: W.primary, marginTop: spaceSm },
    proCardOuter: {
      width: "100%",
      maxWidth: 400,
      marginBottom: inset,
    ...
    completionActions: { flexDirection: "row", gap: gapItem },
    outlineBtn: {
    ...
    primaryBtnText: { color: "#F5F7FF", fontWeight: "700" },
    sadagCardOuter: {
      width: "100%",
      maxWidth: 400,
      marginBottom: gapSection,
    ...
    sadagDate: { fontSize: 11, color: W.textMuted, marginBottom: gapItem },
    sadagLines: { gap: spaceSm, marginBottom: gapItem },
        ...
        <View style={styles.mascotCelebrationWrap}>
          ...
          <View style={styles.checkBadgeOuter}>
            <View style={[styles.checkBadgeInner, { backgroundColor: W.primary }]}>
              <Ionicons name="checkmark" size={28} color="#F5F7FF" />
            </View>
          </View>
        </View>
