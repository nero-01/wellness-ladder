...
type ManualApi = {
  ...
  walkPhase: WalkPhase
  duration: number
  /** Synthetic countdown for voice halfway logic */
  timeLeft: number
  isActive: boolean
  timerCompleted: boolean
  startWalk: () => void
  /** Continue after a short stop without resetting elapsed */
  resumeWalk: () => void
  stopWalk: () => void
  start: undefined
}
...
/**
 * Countdown timer for most tasks, or manual start/stop walk timer for Mindful Walk (and future manual tasks).
 */
