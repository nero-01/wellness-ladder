...
function createStyles(W: WellnessPalette) {
  return StyleSheet.create({
    ...
    actions: { flexDirection: "row", gap: gapItem, marginTop: gapItem },
    iconBtn: {
    ...
    addBtn: {
      ...
      gap: gapItem,
      marginTop: spaceSm,
      paddingVertical: padCard,
      borderRadius: radiusMd,
      backgroundColor: W.primary,
    },
    addBtnDisabled: { opacity: 0.45 },
    addBtnText: { color: "#F5F7FF", fontSize: 16, fontWeight: "700" },
    error: { fontSize: 14, color: W.danger, marginBottom: gapItem },
    errorBox: {
      padding: padCard,
      borderRadius: radiusMd,
      backgroundColor: W.surfaceMuted,
    ...
    retryLabel: { fontSize: 14, fontWeight: "700", color: "#F5F7FF" },
    ...
    saveRow: { flexDirection: "row", gap: gapItem, marginTop: spaceSm },
    secondaryBtn: {
      flex: 1,
      paddingVertical: 14,
      borderRadius: radiusMd,
  ...
  return (
    <SafeAreaView style={styles.safe} edges={["bottom"]}>
      ...
      >
        ...
        >
          <Ionicons name="add-circle-outline" size={22} color="#F5F7FF" />
